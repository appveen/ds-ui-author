...
import { trigger, transition, query, style, group, animate, keyframes, state } from '@angular/animations';
...
export class AdminComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    self.route.params.subscribe(params => {
      if (params.app) {
        const tempApp = self.commonService.appList.find(d => d._id === params.app);
        if (tempApp) {
