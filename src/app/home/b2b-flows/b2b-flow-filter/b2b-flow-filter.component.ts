...
@Component({
  selector: 'odp-b2b-flow-filter',
  templateUrl: './b2b-flow-filter.component.html',
  styleUrls: ['./b2b-flow-filter.component.scss']
})
export class B2bFlowFilterComponent implements IFloatingFilter, AgFrameworkComponent<IFloatingFilterParams> {
